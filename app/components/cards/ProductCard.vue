      ...
      <div class="product-card__img-wrap">
        ...
        <div class="product-card__actions">
          <button
            ...
            :class="{ 'product-card__action-btn--fav-active': isFavorite }"
...
const isFavorite = computed(() => {
  const spu = props.product?.spu ?? props.product?.basicInfo?.spuPoizon ?? ''
  return favoritesStore.isFavorite(String(spu))
})
